...
import elan.nlp.http.HttpClient;
import elan.nlp.http.QueryParameters;
...
public class AlchemyAPI {
    ...
    public static void main(String args[]) {
    	...
    	System.out.println(api.getRankedNamedEntities("http://www.theguardian.com/world/2013/jun/09/booz-allen-hamilton-edward-snowden").asString());
    }
}